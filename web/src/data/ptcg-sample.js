    ...
    abilities: [
      {
        ...
        text_zh:
          '在自己的回合时，可使用1次。查看自己牌库上方的3张卡牌，选择其中1张加入手牌。将其余卡牌放于弃牌区。',
        original_text:
    ...
    attacks: [
      {
        ...
        text_zh: '自己的弃牌区中每有1张“丹帝”，则追加造成50伤害。',
        original_text:
    ...
    attacks: [
      {
        ...
        cost_text: '草、草',
        damage: '20',
        text: 'Unless all damage from this attack is prevented, remove 1 damage counter from Bulbasaur.',
        text_zh: '若这个招式的伤害未被完全抵消，则将妙蛙种子的HP回复10。',
        original_text:
          'Unless all damage from this attack is prevented, remove 1 damage counter from Bulbasaur.',
        converted_energy_cost: 2,
      },
    ],
    weaknesses: [
  ...
  },
  {
    ...
    attacks: [
      ...
      },
      {
        ...
        text_zh: '抛掷1次硬币。若为反面，则皮卡丘也受到10伤害。',
        original_text:
